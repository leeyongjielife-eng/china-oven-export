...
- **今日主线:** Sales 对齐应发 **#93–#98 + #100–#108** + 扩 **#135+**；Co-founder 本机「今天发」15 ⏳
...
## 今日排期（2026-07-29 · Founder 排程 · W3）

**主题：同批续发未投递冷邮 + Sales 扩 #135+**

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales** | 对齐未发草稿 + 标明应发 **#93–#98、#100–#108**（15；仍 Lead） | ⏳ `today.md` pending |
| **P1** | **Sales** | +5 新澳洲买家（从 **#135**；少扩 BG/单店 Weber） | ⏳ |
...
## 上日排期（2026-07-28 · W3）✅ Sales done · 本机「今天发」仍 ⏳

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales** | 对齐应发 #93–#98+#100–#108；+5 #130–#134 | ✅ |
...
| P1 | 外联 100（定价话术见 `product.md` 定价策略） | Co-founder 本机跟进/冷邮 + Sales 草稿 | W3；KPI=真回复；已联系 **84** · 回复 **1** · 今日应发 #93–#98+#100–#108（同批续）；扩 #135+ |
