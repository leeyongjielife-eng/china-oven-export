...
| 阶段 | Phase 0 验证期，0 客户；买家 **154** · 已联系 **114/100** |
...
- **瓶颈:** 已联系 **114/100**；距 W4 还差 Contacted≥100 **且** 回复≥5（当前回复 **1**）；下一批冷邮 **#109–#123**（仍 Lead，同批续发）
- **优势:** 买家 **149**；Gmail MCP ✅；发信政策已统一（`今天发` · 15/工作日 · 云端不实发）；本机 Contacted SSOT 已合入 main
- **今日主线:** Sales 对齐应发 **#109–#123** + 扩 **#150+**；Co-founder 本机「今天发」15 ⏳
...
## 今日排期（2026-08-01 · Founder 排程 · W3 · 周六）

**主题：同批续发冷邮 #109–#123 + Sales 扩 #150+**

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales** | 对齐未发草稿 + 标明应发 **#109–#123**（15；仍 Lead） | ⏳ `today.md` pending |
| **P1** | **Sales** | +5 新澳洲买家（从 **#150**；少扩 BG/单店 Weber） | ⏳ |
| **P0** | **Co-founder / 本机** | 说「**今天发**」15 封（Gmail 仅本机） | ✅ #109–#123 |
| ⏸️ | — | 不问叔叔；不切 Research Reset；#6/#17 Bounce 不自动补 | ✅ |

**Founder 阶段检查：** 保持 `W3_OUTREACH`（已联系 **114** &lt; 100 · 回复 **1** &lt; 5）；KPI=真回复。

### Co-founder 今日说明

- 本机说「**今天发**」→ 冷邮队列 **#109–#123**
- 跳过 `#3/#13/#15`；`#6/#17` Bounce 不自动补；`#99` 无邮箱

### 明日排期（2026-08-02 · 周日 · W3）

| 优先级 | 指派 | 任务 | 目标 |
|:---:|------|------|------|
| **P0** | **Research** | 周日轻量复核（竞品价 / 关键词 / 周日志） | 不扩冷邮 |
| **P1** | **本机** | 视周六实发：续 `#124+` 或跟进静默 Contacted | Contacted↑ / 推回复 |

---

## 上日排期（2026-07-31 · W3）✅ Sales done · 本机「今天发」⏳

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales** | 对齐应发 #109–#123；+5 #145–#149 | ✅ |
| **P0** | **Co-founder / 本机** | 「今天发」15（#109–#123） | ⏳ pipeline 仍 Lead → 今日同批续发 |
...
| P1 | 外联 100（定价话术见 `product.md` 定价策略） | Co-founder 本机跟进/冷邮 + Sales 草稿 | W3；KPI=真回复；已联系 **114** · 回复 **1** · 今日应发 #109–#123；扩 #150+ |
