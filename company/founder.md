...
- 「今天发」→ `#160–#168` 首封 + 跟进 `#4 #10 #20 #64 #92 #97`（已完成）
- 跳过 Bounce/#41/B/C/#3/#13；不问叔叔
...
| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **本机** | 冷邮 `#155–#159` + 跟进 10 | ✅ 15/15（#158 后 Bounce） |
| **P1** | **Sales** | 补 A `#160–#168` | ✅ |
