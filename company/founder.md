...
## 今日排期（2026-08-05 · 周三 · W3 · A 软切选项 2）

**主题：发完 A Lead 余量 + 库存闸门补 A + 跟进凑满 15**

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **本机** | 「今天发」冷邮 `#155–#159`（5）+ A 跟进 10 | ✅ 15/15 |
| **P1** | **Sales / 本机** | 补 **≥9** 家 A `#160–#168`（发后 A Lead=15&lt;20） | ✅ |
| 📅 | — | **8/9** Research 复评 | 锁定 |

### Co-founder 今日说明

- 「今天发」→ `#155–#159` 首封 + 跟进 `#1 #2 #93 #94 #95 #96 #120 #121 #122 #123`
...
| 优先级 | 指派 | 任务 | 目标 |
|:---:|------|------|------|
| **P0** | **本机** | 新 A Lead 冷邮（#160+）和/或 A 跟进 | 求回复 |
| **P1** | **Sales** | 若 A Lead 仍 &lt;20 继续补 A | 闸门 |
| 📅 | **Founder** | **8/9** 复评 | 决策 |

---

## 上日排期（2026-08-04 · 周二）✅ 冷邮 #139–#154

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **本机** | A Lead `#139–#154` | ✅ 15/15 |
| **P1** | **Sales** | 停日扩（当时 A Lead≥20） | ✅ |
