...
- **今日主线（2026-08-25 · 周二）：** 续同批冷 `#213–#221`（9）+ A 跟进 `#1 #2 #93–#96`（6）=15 对齐；P1 停扩；本机 **「今天发」**；**勿催 Brad / Martin / `#175` OOO**
...
## 今日排期（2026-08-25 · 周二）✅ Sales 对齐 · ⏳ 待本机「今天发」
...
## 上日排期（2026-08-24 · 周一）✅ Sales 对齐 · ⏳ 待本机「今天发」（未投递 → 今日续同批）
...
## 上上日排期（2026-08-23 · 周日）✅ Sales 对齐 · 周一「今天发」（未投递 → 续同批）
