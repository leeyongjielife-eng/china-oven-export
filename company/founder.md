...
- **Phase:** 0 — **`W3_OUTREACH`**（Week 3 外联 · Day 3 · 已派发）→ 切换见 [`phases.md`](phases.md)
- **瓶颈:** Gmail MCP / 发信通道尚未搭建；已发信 **0/100**
- **优势:** 买家 **60/100**；外联草稿/脚本 **39/40**；60 lead 均可触达
- **本周必须完成:** 搭建 Gmail MCP 后启动首批 #1、#2、#4–#12、#14–#20 外联；若通道仍不可用，Sales 继续补 #41–#60 草稿/脚本并每天补 5+ 新买家
...
## 今日排期（2026-07-16 · Founder 排程 · W3 Day 3）⏳ 已派发

**主题：Week 3 Day 3 — 发信通道确认 + 草稿队列扩到 60**

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales** | Gmail MCP 就绪则发送 15–20 封；否则补 #41–#60 草稿/脚本，把可发送队列扩大到 60 | ⏳ 派发 |
| **P1** | **Sales** | 新增 5 家澳洲买家 → 65/100 | ⏳ 派发 |
...
### 明日排期（2026-07-17 · W3 Day 4）

| 优先级 | 指派 | 任务 | 目标 |
|:---:|------|------|------|
| **P0** | **Sales** | Gmail MCP 就绪后发送 15–20 封；否则继续扩大草稿/可发送队列 | 已发信开始计数，或草稿/脚本超过 60 |
| **P1** | **Sales** | 再找 5 家买家 | 70/100 |
