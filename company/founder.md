...
| 阶段 | Phase 0 验证期，0 客户；买家 **144** · 已联系 **99/100** |
...
- **瓶颈:** 已联系 **99/100**；距 W4 还差 Contacted≥100 **且** 回复≥5（当前回复 **1**）；下一批冷邮 **#109–#123**
- **优势:** 买家 **144**；Gmail MCP ✅；发信政策已统一（`今天发` · 15/工作日 · 云端不实发）；本机 Contacted SSOT 已合入 main
- **今日主线:** Sales 对齐应发 **#109–#123** + 扩 **#140–#144** ✅；Co-founder 本机「今天发」15 ⏳
...
## 今日排期（2026-07-30 · Founder 排程 · W3）

**主题：下一批冷邮 #109–#123 + Sales 扩 #140+**

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales** | 对齐未发草稿 + 标明应发 **#109–#123**（15） | ✅ `today.md` done |
| **P1** | **Sales** | +5 新澳洲买家（从 **#140**；少扩 BG/单店 Weber） | ✅ #140–#144 |
...
## 上日排期（2026-07-29 · W3）✅ Sales done · 本机「今天发」✅ → 已联系 99

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales** | 对齐应发 #93–#98+#100–#108；+5 #135–#139 | ✅ |
| **P0** | **Co-founder / 本机** | 「今天发」15（#93–#108 跳 #99） | ✅ Contacted 98 · 已联系 99 |
...
| P1 | 外联 100（定价话术见 `product.md` 定价策略） | Co-founder 本机跟进/冷邮 + Sales 草稿 | W3；KPI=真回复；已联系 **99** · 回复 **1** · 今日应发 #109–#123；扩 #140+ |
