...
- **今日主线（2026-09-01 · 周二）：** 续同批冷 `#213–#221`（9）+ A 跟进 `#1 #2 #93–#96`（6）=15 对齐；P1 停扩；本机 **「今天发」**；**勿催 Brad / Martin / `#175` OOO**
...
## 今日排期（2026-09-01 · 周二）✅ Sales 对齐 · ⏳ 本机「今天发」
...
## 上日排期（2026-08-31 · 周一）✅ Sales 对齐 · ⏳ 本机「今天发」（未投递 → 今日续同批）
...
## 上上日排期（2026-08-30 · 周日）✅ 软切复评 · Sales 对齐 · ⏳ 周一「今天发」（未投递 → 续同批）

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales → 本机** | 续同批冷邮 `#213–#221`（9）+ A 跟进 `#1 #2 #93 #94 #95 #96`（6） | ✅ Sales 对齐 · ⏳ 周一本机 |
| **P1** | **Sales** | **停扩**（A Lead=20≥20） | ✅ |
