...
- **优势:** 买家 **129**；Gmail MCP ✅；发信政策已统一（`今天发` · 15/工作日 · 云端不实发）；本机 Contacted SSOT 已合入 main
...
| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales** | 对齐未发草稿 + 标明应发 **#93–#98、#100–#108**（15；仍 Lead） | ⏳ `today.md` pending |
| **P1** | **Sales** | +5 新澳洲买家（从 **#130**；少扩 BG/单店 Weber） | ⏳ |
