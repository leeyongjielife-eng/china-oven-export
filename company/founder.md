...
| 阶段 | Phase 0 验证期，0 客户；买家 **129** · 已联系 **84/100** |
...
- **瓶颈:** 已联系 **84/100**；距 W4 还差 Contacted≥100 **且** 回复≥5（当前回复 **1**）；昨日应发批仍 Lead → 今日续发 **#93–#98 + #100–#108**
- **优势:** 买家 **124**；Gmail MCP ✅；发信政策已统一（`今天发` · 15/工作日 · 云端不实发）；本机 Contacted SSOT 已合入 main
- **今日主线:** Sales 对齐应发 **#93–#98 + #100–#108** + 补 **#109–#119** 草稿 + 扩 **#125–#129** ✅；Co-founder 本机「今天发」15 ⏳
- **暂不做:** 问叔叔（等 Replied/Qualified）；Bounce **不自动补**（须明说「改发备用」）；不切 W4
...
## 今日排期（2026-07-27 · Founder 排程 · W3）

**主题：续发未投递冷邮批 + Sales 补草稿/扩 #125+**

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales** | 对齐未发草稿 + 标明应发 **#93–#98、#100–#108**（15）；补 **#109–#119** | ✅ `today.md` done |
| **P1** | **Sales** | +5 新澳洲买家（从 **#125**；少扩 BG/单店 Weber） | ✅ #125–#129 |
| **P0** | **Co-founder / 本机** | 说「**今天发**」15 封（Gmail 仅本机） | ⏳ |
| ⏸️ | — | 不问叔叔；不切 Research Reset；#6/#17 Bounce 不自动补 | ✅ |

**Founder 阶段检查：** 保持 `W3_OUTREACH`（已联系 **84** &lt; 100 · 回复 **1** &lt; 5）；KPI=真回复。

### Co-founder 今日说明

- 本机说「**今天发**」→ 冷邮队列 **#93–#98 + #100–#108**
- 跳过 `#3/#13/#15`；`#6/#17` Bounce 不自动补；`#99` 无邮箱

### 明日排期（2026-07-28 · 周二 · W3）

| 优先级 | 指派 | 任务 | 目标 |
|:---:|------|------|------|
| **P0** | **本机** | 视今日实发：续冷邮 `#109+` 或跟进静默 Contacted | Contacted↑ / 推回复 |
| **P1** | **Sales** | 继续换画像扩买家 | 可发池 |

---

## 上日排期（2026-07-26 · W3）✅ Sales done · 本机「今天发」仍 ⏳

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales** | 对齐应发 #93–#98+#100–#108；+5 #120–#124 | ✅ |
| **P0** | **Co-founder / 本机** | 「今天发」15 | ⏳ 未写回 Contacted（仍 84） |
...
| P1 | 积满 **50 买家** | Sales | ✅ **129**；W3 外联池续扩 |
| P1 | 外联草稿备齐 | Sales | 进行中；Kit Lee / indicative FOB |
| P1 | 补联系人 A 级 | Sales | 持续补 |
| P1 | 外联 100（定价话术见 `product.md` 定价策略） | Co-founder 本机跟进/冷邮 + Sales 草稿 | W3；KPI=真回复；已联系 **84** · 回复 **1** · 今日应发 #93–#98+#100–#108（续） |
