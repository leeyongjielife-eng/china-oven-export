...
- **Phase:** 0 — **`W3_OUTREACH`** + **A 软切 + 选项 2**（**续至 9/13**；回复 **4**&lt;5 → 不切 W4）
- **瓶颈:** 回复 **4**/5；热线索等对方（Alex 选尺寸、Brad/Angela 不催）；同批冷邮多日未本机投递
- **优势:** 买家 **221**；Contacted **191**；A Lead **20≥20**（闸门关）；`#132` HiBBQ 已 Yes
- **今日主线（2026-09-09 · 周三）：** 续同批冷 `#213–#221`（9）+ A 跟进 `#1 #2 #93–#96`（6）=15 对齐；P1 停扩；**本机「今天发」**；**勿催 Brad / Martin / Angela**；`#175` OOO 已于 9/7 截止（仍不入本批）
- **明日：** 若本机已发 → 按 Contacted 推进；未发则续同批；盯 `#132` 选尺寸；A Lead 闸门随投递再开
- **暂不做:** B/C；催 #41；硬切 Reset；**9/13 前不正式 Research**；Bounce 不自动补；电话未授权
...
应发队列仍为冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（共 15）。**周三**本机说 **「今天发」**。云端不实发。等 `#132` 选尺寸。软切+选项 2 续至 **9/13**。

---

## 今日排期（2026-09-09 · 周三）✅ Sales 对齐 · ⏳ 本机「今天发」

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales → 本机** | 续同批冷邮 `#213–#221`（9）+ A 跟进 `#1 #2 #93 #94 #95 #96`（6） | ✅ Sales 对齐 · ⏳ 本机「今天发」 |
| **P1** | **Sales** | **停扩**（A Lead=20≥20） | ✅ |

---

## 上日排期（2026-09-08 · 周二）✅ Sales 对齐 · ⏳ 本机「今天发」（未投递 → 今日续同批）

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales → 本机** | 续同批冷邮 `#213–#221`（9）+ A 跟进 `#1 #2 #93 #94 #95 #96`（6） | ✅ Sales 对齐 · ⏳ 本机未投递 |
| **P1** | **Sales** | **停扩**（A Lead=20≥20） | ✅ |

---

## 上上日排期（2026-09-07 · 周一）✅ Sales 对齐 · ⏳ 本机「今天发」（未投递 → 续同批）
...
## 上上日排期（2026-09-06 · 周日）✅ Sales 对齐 · 🚫 周日不发（未投递 → 续同批）

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales → 本机** | 续同批冷邮 `#213–#221`（9）+ A 跟进 `#1 #2 #93 #94 #95 #96`（6） | ✅ Sales 对齐 · 🚫 周日不发 |
| **P1** | **Sales** | **停扩**（A Lead=20≥20） | ✅ |
...
| P1 | 外联 100（定价话术见 `product.md` 定价策略） | Co-founder 本机跟进/冷邮 + Sales 草稿 | W3 **A 软切+选项2**：A Lead 首封 · 停日扩（A Lead&lt;20 须补 A）· 回复 **4** · **9/13** 再复评 |
...
| 4 | Research Reset / 软切复评 | 是否换国或硬切 | ✅ **2026-09-06 续软切+选项2 至 9/13**（`#213–#221` 仍未投递；回复 4&lt;5；不切 W4 / 不硬切 / 不正式 Research） |
...
| 日期 | 调度 | 任务 | 结果写回 |
|------|------|------|----------|
| 2026-09-09 | **Sales 完成** | W3：续对齐应发冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 停扩；未发信、未标 Contacted；待本机「今天发」 | `outreach-drafts.md` · `sales.md` · `today.md` done |
| 2026-09-09 | **Founder → Sales** | W3：阶段保持 W3；选项 2 → P0 **续同批**冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 **停扩**（A Lead=20）；Co-founder 本机「今天发」；禁止 Gmail | `today.md` pending |
| 2026-09-08 | **Sales 完成** | W3：续对齐应发冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 停扩；未发信、未标 Contacted；待本机「今天发」 | `outreach-drafts.md` · `sales.md` · `today.md` done |
| 2026-09-08 | **Founder → Sales** | W3：阶段保持 W3；选项 2 → P0 **续同批**冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 **停扩**（A Lead=20）；Co-founder 本机「今天发」；禁止 Gmail | `today.md` pending |
| 2026-09-07 | **Sales 完成** | W3：续对齐应发冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 停扩；未发信、未标 Contacted；待本机「今天发」 | `outreach-drafts.md` · `sales.md` · `today.md` done |
| 2026-09-07 | **Founder → Sales** | W3：阶段保持 W3；选项 2 → P0 **续同批**冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 **停扩**（A Lead=20）；Co-founder 本机「今天发」；禁止 Gmail | `today.md` pending |
| 2026-09-06 | **Sales 完成** | W3：续对齐应发冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 停扩；未发信、未标 Contacted；**周日不发** | `outreach-drafts.md` · `sales.md` · `today.md` done |
| 2026-09-06 | **Founder → Sales** | W3：**9/6 软切复评** → 续选项 2 至 **9/13**；P0 **续同批**冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 **停扩**（A Lead=20）；**周日不发**；周一「今天发」；禁止 Gmail | `today.md` pending · `strategy.md` · `phases.md` |
| 2026-09-05 | **Sales 完成** | W3：续对齐应发冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 停扩；未发信、未标 Contacted | `outreach-drafts.md` · `sales.md` · `today.md` done |
| 2026-09-05 | **Founder → Sales** | W3：阶段保持 W3；选项 2 → P0 **续同批**冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 **停扩**（A Lead=20）；Co-founder 本机「今天发」；禁止 Gmail；**明日 9/6 软切复评** | `today.md` pending |
| 2026-09-04 | **Sales 完成** | W3：续对齐应发冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 停扩；未发信、未标 Contacted | `outreach-drafts.md` · `sales.md` · `today.md` done |
| 2026-09-04 | **Founder → Sales** | W3：阶段保持 W3；选项 2 → P0 **续同批**冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 **停扩**（A Lead=20）；Co-founder 本机「今天发」；禁止 Gmail | `today.md` pending |
| 2026-09-03 | **Sales 完成** | W3：续对齐应发冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 停扩；未发信、未标 Contacted | `outreach-drafts.md` · `sales.md` · `today.md` done |
| 2026-09-03 | **Founder → Sales** | W3：阶段保持 W3；选项 2 → P0 **续同批**冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 **停扩**（A Lead=20）；Co-founder 本机「今天发」；禁止 Gmail | `today.md` pending |
| 2026-09-02 | **Sales 完成** | W3：续对齐应发冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 停扩；未发信、未标 Contacted | `outreach-drafts.md` · `sales.md` · `today.md` done |
| 2026-09-02 | **Founder → Sales** | W3：阶段保持 W3；选项 2 → P0 **续同批**冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 **停扩**（A Lead=20）；Co-founder 本机「今天发」；禁止 Gmail | `today.md` pending |
| 2026-09-01 | **Sales 完成** | W3：续对齐应发冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 停扩；未发信、未标 Contacted | `outreach-drafts.md` · `sales.md` · `today.md` done |
| 2026-09-01 | **Founder → Sales** | W3：阶段保持 W3；选项 2 → P0 **续同批**冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 **停扩**（A Lead=20）；Co-founder 本机「今天发」；禁止 Gmail | `today.md` pending |
| 2026-08-31 | **Sales 完成** | W3：续对齐应发冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 停扩；未发信、未标 Contacted | `outreach-drafts.md` · `sales.md` · `today.md` done |
| 2026-08-31 | **Founder → Sales** | W3：阶段保持 W3；选项 2 → P0 **续同批**冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 **停扩**（A Lead=20）；Co-founder 本机「今天发」；禁止 Gmail | `today.md` pending |
| 2026-08-30 | **Sales 完成** | W3：续对齐应发冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 停扩；未发信、未标 Contacted；**周日不发** | `outreach-drafts.md` · `sales.md` · `today.md` done |
| 2026-08-30 | **Founder → Sales** | W3：**8/30 软切复评** → 续选项 2 至 **9/6**；P0 **续同批**冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 **停扩**（A Lead=20）；**周日不发**；周一「今天发」；禁止 Gmail | `today.md` pending · `strategy.md` · `phases.md` |
| 2026-08-29 | **Sales 完成** | W3：续对齐应发冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 停扩；未发信、未标 Contacted | `outreach-drafts.md` · `sales.md` · `today.md` done |
| 2026-08-29 | **Founder → Sales** | W3：阶段保持 W3；选项 2 → P0 **续同批**冷 `#213–#221` + A 跟进 `#1 #2 #93–#96`（15）；P1 **停扩**（A Lead=20）；Co-founder 本机「今天发」；禁止 Gmail；**8/30** 复评 | `today.md` pending |
