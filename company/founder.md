...
## 今日排期（2026-08-02 · Founder 排程 · W3 · 周日）

**主题：Contacted≥100 → 跟进静默 Contacted + Sales 扩 #155+（停新冷邮）**

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales** | 跟进 Contacted：对齐草稿 **#34 #35 #36 #37 #38 #39 #40 #42 #43 #44 #45 #47 #49 #50 #51**（15） | ✅ `today.md` done |
| **P1** | **Sales** | +5 新澳洲买家（从 **#155**；少扩 BG/单店 Weber） | ✅ #155–#159 |
| **P0** | **Co-founder / 本机** | 说「**今天发**」15 封（Gmail 仅本机）· ≥100 停新冷邮 · 周日不发冷邮 | ✅ 跟进 #34–#51 |
| ⏸️ | — | 不问叔叔；不切 Research Reset；#6/#17 Bounce 不自动补；不派新冷邮 | ✅ |

**Founder 阶段检查：** 保持 `W3_OUTREACH`（Contacted **113**≥100 但回复 **1** &lt; 5 → 未切 W4）；KPI=真回复。
...
## 上日排期（2026-08-01 · W3）✅ Sales done · 本机「今天发」✅ #109–#123

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales** | 对齐应发 #109–#123；+5 #150–#154 | ✅ |
| **P0** | **Co-founder / 本机** | 「今天发」15（#109–#123） | ✅ Contacted **113** · 已联系 **114** |
