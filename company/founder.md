...
- **今日主线:** Sales 对齐应发 **#109–#123** + 扩 **#145–#149** ✅；Co-founder 本机「今天发」15 ⏳
...
## 今日排期（2026-07-31 · Founder 排程 · W3）

**主题：同批续发冷邮 #109–#123 + Sales 扩 #145+**

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales** | 对齐未发草稿 + 标明应发 **#109–#123**（15；仍 Lead） | ✅ `today.md` done |
| **P1** | **Sales** | +5 新澳洲买家（从 **#145**；少扩 BG/单店 Weber） | ✅ #145–#149 |
...
### 明日排期（2026-08-01 · 周六 · W3）

| 优先级 | 指派 | 任务 | 目标 |
|:---:|------|------|------|
| **P0** | **本机** | 视今日实发：续冷邮 `#124+` 或跟进静默 Contacted | Contacted↑ / 推回复 |
| **P1** | **Sales** | 继续换画像扩买家 | 可发池 |

---

## 上日排期（2026-07-30 · W3）✅ Sales done · 本机「今天发」⏳

| 优先级 | 谁 | 任务 | 状态 |
|:---:|------|------|:---:|
| **P0** | **Sales** | 对齐应发 #109–#123；+5 #140–#144 | ✅ |
...
| P1 | 外联 100（定价话术见 `product.md` 定价策略） | Co-founder 本机跟进/冷邮 + Sales 草稿 | W3；KPI=真回复；已联系 **99** · 回复 **1** · 今日应发 #109–#123；扩 #145+ |
