...
- **今日主线（2026-08-19 · 周三）：** P0 **续发**冷 `#179–#183` + A 跟进 `#145–#154`（15）；P1 **停扩**；本机「今天发」
...
## 今日排期（2026-08-19 · 周三）⏳ Sales 待执行 · ⏳ 本机「今天发」
...
## 上日排期（2026-08-18 · 周二）✅ Sales 对齐 · ⏳ 本机「今天发」
...
## 上上日排期（2026-08-17 · 周一）✅ Sales 对齐 · ⏳ 本机「今天发」
