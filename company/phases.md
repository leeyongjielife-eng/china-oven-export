...
| `W3_OUTREACH` | 外联 100 | 外联 15–20/天 + 新买家 5/天 | **允许** | 已联系 ≥100 **且** 回复 ≥5 → `W4_FOLLOWUP` |
...
|--------|------------------------|
| `W3_OUTREACH` | **搭建 Gmail MCP**；确认 Sales/Founder Instructions 允许发信 |
...
| `W3_OUTREACH` | 外联 #N→#M（见 outreach 队列） | +5 新买家 |
