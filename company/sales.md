...
> **本文件唯一归属**：销售阶段定义、当前漏斗数字、Pipeline 摘要。
>
> | 需要的信息 | 读取 |
> |-----------|------|
> | 外联模板、写作原则 | [`../templates/outreach.md`](../templates/outreach.md) |
...
*同步：2026-08-04 冷邮 `#139–#154` 15/15 ✅ · **A Lead=11 &lt;20 → 库存闸门触发**（软切例外：须补 A）· #126 无邮箱改发*

*可发 A Lead 余量约 `#155–#159`（5）；其余 A Lead 为跳过/Bounce/无邮箱*
