...
```text
Founder Agent（AI）     →  研究、策略、排期、写邮件草稿、维护 company/
Co-founder（你）        →  供应商人脉、拍板、微信/电话、付款、验货
```
...
| 2026-07-12 | 启用 **「Kamado 每日 Founder — 澳洲」** | **Active**；每天 09:00 GMT+8 · branch `main`；**7/13 首次跑** |
