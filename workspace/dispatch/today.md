...
- 当前阶段：`W3_OUTREACH`
- 账本 SSOT：已联系 **84/100** · 回复 **1** · 买家 **129** · Contacted **83**
- **今日应发（冷邮 Lead #，15）：** `#93–#98` + `#100–#108`（昨日未实发，仍 Lead → 同批续发）
...
- [ ] 新增 **5** 家 **#130–#134**（own-brand / distributor / importer；少扩 BG/单店 Weber）
- [ ] 有可发邮箱（≥B）；Notes 标 `ICP: …`
- [ ] 新买家补草稿；同步 `sales.md`
